...
public class Pilihan_Menu
{

    Scanner input = new Scanner(System.in);

    String input_pilihan_menu_dokter, registrasi_email_dokter, registrasi_password_dokter, login_email_dokter, login_password_dokter, verifikasi_data_pasien = "sedang di verifikasi",input_pilihan_menu_pasien,registrasi_email_pasien, registrasi_password_pasien, login_email_pasien, login_password_pasien, registrasi_nama_pasien, registrasi_alamat_pasien;
    int input_pilihan_menu,input_verifikasi_pasien,input_proses_perubahan_data_pasien;

     ArrayList <Data_Dokter_Rumah_Sakit> data_dokter = new ArrayList <Data_Dokter_Rumah_Sakit>();
    ArrayList <data_Pasien_Rumah_Sakit> data_pasien = new ArrayList<data_Pasien_Rumah_Sakit>();
    ...
    public void pilihan_menu_dokter()
    {
        ...
        proses_pilihan_menu_dokter();
    }
    public void proses_pilihan_menu_dokter()
    {
        switch (input_pilihan_menu_dokter)
        {
            case "1":
            {
    ...
    public void Proses_registrasi_dokter()
    {
        ...
        data_dokter.add(new Data_Dokter_Rumah_Sakit(registrasi_email_dokter,registrasi_password_dokter));
    }
    ...
    public void registrasi_pasien()
    {
        ...
        data_pasien.add(new data_Pasien_Rumah_Sakit(registrasi_email_pasien,registrasi_password_pasien,"sedang diverifikasi",registrasi_nama_pasien,registrasi_alamat_pasien));
    }
